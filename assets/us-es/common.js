...
const PICKER_TEXT = {
  languageLabel: 'Idioma en {country}',
  unavailableLanguage: "{language} todavía no está disponible para esta página en {country}; se muestra English. Disponible aquí: {available}.",
};
