...
const LS_TEXT = {
  volts: '{volts} V',
  voltsAt: '{volts} V en {label}',
  feet: '{feet} ft',
  amps: '{amps} A',
  percent: '{percent}%',
  lowestLabel: 'tensión más baja, en {label}',
  fixtureCount: '{count} luminarias',
  oneFixture: '1 luminaria',
  tapLine: '{label} — {count}',
  tapLineBranch: '{branch} {label} — {count}',
  branchAShort: 'A',
  branchBShort: 'B',
  tapVolts: '{volts} V  ({percent}% de caída)',
  layoutDaisy: 'En cadena',
  layoutTsplit: 'T / derivación',
  layoutHub: 'Hub',
  layoutStar: 'Estrella',
  yoursSuffix: ' — el suyo',
  colLayout: 'Disposición',
  colLowest: 'Mínima',
  colHighest: 'Máxima',
  colSpread: 'Diferencia',
  colCable: 'Cable',
  colLowestVolts: 'Mínima V',
  colSpreadVolts: 'Diferencia V',
  colCableFeet: 'Cable ft',
  colTotalLoad: 'Carga total',
  colWorstDrop: 'Caída máxima',
  hubAtFt: 'Hub (a {feet} ft)',
  hubSuggested: 'Hub (sugerido a {feet} ft)',
  hubSuggestedNote: 'No ha fijado una distancia de hub, así que la fila del hub se calcula en el punto medio de su recorrido, que suele estar cerca del mejor sitio. Fije su propia distancia para comparar otra.',
  noResultDash: '—',
  tapsHeading: 'Tensión en cada luminaria',
  compareHeading: 'Las mismas luminarias, cableadas de cuatro maneras',
  assumption: 'Esta comparación supone que sus luminarias siguen un solo recorrido y que todas las distancias se miden a lo largo de él: un arriate, un paseo o una entrada. Las luminarias repartidas en direcciones distintas tienen su propia geometría, que esta herramienta no puede conocer.',
  hubIsStar: 'Un hub a 0 ft es el mismo circuito que una estrella, así que esas dos filas coinciden.',
  hintDaisy: 'Un solo cable, derivando cada luminaria por orden. Las distancias se miden a lo largo del cable.',
  splitDistanceLabel: 'La derivación está a esta distancia del transformador',
  splitDistanceHint: 'Hasta dónde llega el tronco antes de dividirse en dos ramales. Después, la distancia de cada luminaria se mide a lo largo de su propio ramal, desde esa derivación.',
  hubDistanceLabel: 'El hub está a esta distancia del recorrido',
  hubDistanceHint: 'Hasta dónde llega el tronco antes de repartirse. Un hub a 0 ft es el mismo circuito que una estrella.',
  hintTsplit: 'Un tronco hasta una derivación y de ahí dos ramales en sentidos opuestos. Las distancias se miden a lo largo de cada ramal DESDE LA DERIVACIÓN, no desde el transformador.',
  hintHub: 'Un tronco hasta un hub y de ahí un ramal separado a cada luminaria.',
  hintStar: 'Un cable separado desde el transformador hasta cada luminaria.',
  cautionUnityPf: 'Los vatios por sí solos no dan la corriente. Al no introducir factor de potencia hemos supuesto 1.0, que es el mejor caso: la corriente real es mayor y también la caída de tensión real. Use los amperios nominales o los VA de la luminaria para obtener una respuesta firme.',
  cautionWatch: 'La caída aquí es lo bastante grande como para merecer una segunda mirada antes de enterrar el cable.',
  cautionUnreliable: 'Con esta caída el método de corriente fija deja de ser fiable: un driver LED consume más corriente a medida que le baja la tensión, así que la caída real es peor que la mostrada. Suba de calibre, acorte el recorrido o reparta la carga.',
  cautionCollapse: 'Este diseño no puede funcionar. El cable no puede entregar esta carga a esta distancia: la tensión se derrumba. Cambie el calibre del cable, la distancia o el número de luminarias.',
  cautionAmpacity: 'Esto responde únicamente a la caída de tensión. No comprueba que el cable esté clasificado para conducir la corriente, ni comprueba la capacidad nominal de su transformador.',
  cautionLimitsUnset: 'No evaluado frente a los límites del fabricante. Introduzca la tensión mínima y máxima de su luminaria para que se compruebe cada derivación.',
  cautionBelowMin: '{count} de sus derivaciones quedan por debajo del mínimo de {volts} V que introdujo.',
  cautionAboveMax: '{count} de sus derivaciones quedan por encima del máximo de {volts} V que introdujo. La sobretensión acorta la vida de la luminaria, sobre todo con halógenas.',
  needTwoRows: 'Introduzca una distancia y una carga para al menos una luminaria.',
  badInput: 'Esos números no describen un circuito que podamos resolver. Revise las distancias y las cargas.',
  mathIntro: 'Cada tramo de cable lleva la corriente de todas las luminarias que están más allá, así que la caída se calcula tramo por tramo y se suma a lo largo del recorrido hasta cada luminaria.',
  mathFormula: 'caída por tramo = 2 × K × A × ft ÷ cmil',
  mathConstants: 'K = {k} para {material}. Cable = {size} ({cm} cmil). Las distancias son de ida; el 2 corresponde al par de ida y vuelta.',
  mathNaive: 'Para comparar, poner los {amps} A completos a los {feet} ft completos — como haría una calculadora normal — da {volts} V de caída, lo que la exagera.',
  materialCopper: 'cobre',
  materialAluminum: 'aluminio',
  badgeOk: 'CORRECTO',
  badgeCheck: 'REVISAR',
  badgeStop: 'NO FUNCIONARÁ',
};
