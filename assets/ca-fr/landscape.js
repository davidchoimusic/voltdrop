...
const LS_TEXT = {
  ...
  compareHeading: 'Les mêmes luminaires, câblés de quatre façons',
  ...
  splitDistanceLabel: 'La dérivation est à cette distance du transformateur',
  splitDistanceHint: 'Jusqu’où va le tronc avant de se diviser en deux branches. La distance de chaque luminaire se mesure ensuite le long de sa propre branche, à partir de cette dérivation.',
  hubDistanceLabel: 'Le moyeu est à cette distance sur le parcours',
  hubDistanceHint: 'Jusqu’où va le tronc avant de se diviser. Un moyeu à 0 ft est le même circuit qu’une étoile.',
  hintTsplit: 'Un tronc jusqu’à une dérivation, puis deux branches en sens opposés. Les distances se mesurent le long de chaque branche À PARTIR DE LA DÉRIVATION, non du transformateur.',
