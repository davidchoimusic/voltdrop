...
const SYSTEMS = {
  dc:  { name: 'DC', mult: 1, usesPF: false, multLabel: '', hint: 'DC: batteries, solaire, véhicules, LED rubans.' },
  ac1: { name: 'AC monophasé', mult: 1, usesPF: true, multLabel: '', hint: 'monophasé: normal household et light commercial circuits.' },
  ac3: { name: 'AC triphasé', mult: SQRT3, usesPF: true, multLabel: '√3 × ', hint: 'triphasé: commercial et industrial. entrez entre phases tension.' },
};
const POWER_RESULT_TEXT = {
  ...
  ampsFormula: 'Ampères = watts ÷ ({mult}volts)\n     = {watts} ÷ ({mult}{volts})\n     = {amps} A',
  ampsPfFormula: 'Ampères = watts ÷ ({mult}volts × PF)\n     = {watts} ÷ ({mult}{volts} × {pf})\n     = {amps} A',
  ampsOhmsFormula: 'Ampères = volts ÷ {quantity}\n        = {volts} ÷ {ohms}\n        = {amps} A',
  wattsFormula: 'Watts = {mult}volts × ampères\n      = {mult}{volts} × {amps}\n      = {watts} W',
  wattsPfFormula: 'Watts = {mult}volts × ampères × PF\n      = {mult}{volts} × {amps} × {pf}\n      = {watts} W',
  voltsFormula: 'Volts = watts ÷ ({mult}ampères)\n      = {watts} ÷ ({mult}{amps})\n      = {volts} V',
  voltsPfFormula: 'Volts = watts ÷ ({mult}ampères × PF)\n      = {watts} ÷ ({mult}{amps} × {pf})\n      = {volts} V',
  voltsOhmsFormula: 'Volts = ampères × {quantity}\n      = {amps} × {ohms}\n      = {volts} V',
  resistanceFormula: 'Résistance = volts ÷ ampères\n           = {volts} ÷ {amps}\n           = {ohms} Ω',
  impedanceFormula: 'Impédance = volts ÷ ampères\n          = {volts} ÷ {amps}\n          = {ohms} Ω\nPartie résistive ≈ impédance × PF\n                  = {ohms} × {pf}\n                  ≈ {resistance} Ω',
...
const POWER_UI_TEXT = {
  ...
  amps: 'ampères',
  watts: 'watts',
  resistanceR: 'Résistance (R)',
  impedanceZ: 'Impédance (Z)',
  resistivePartResistance: 'Partie résistive — Résistance (R ≈ Z × facteur de puissance)',
  apparentPower: 'apparente puissance',
  powerFactor: 'facteur de puissance',
  checkInput: 'VÉRIFIEZ LES DONNÉES',
  enterPositiveValues: 'Entrez une valeur supérieure à zéro dans chaque champ affiché.',
  currentMustBeGreaterThanZero: 'Le courant doit être supérieur à zéro pour calculer la résistance ou l’impédance. Entrez les ampères mesurés.',
  ohmsMustBeGreaterThanZero: 'Entrez une valeur supérieure à 0 Ω. Une valeur de 0 Ω est un court-circuit franc et rendrait le courant calculé infini.',
  nextStep: 'Étape suivante : comparez ce courant au calibre et au courant admissible avant de choisir un conducteur.',
};
...
function applyMode() {
  ...
  $('pw-ohms-label').textContent = system === 'dc' ? 'Résistance (Ω)' : 'Impédance (Ω)';
