...
const PICKER_TEXT = {
  languageLabel: 'Langue au {country}',
  unavailableLanguage: "{language} n’est pas encore disponible pour cette page au {country}; affichage en English. Disponible ici : {available}.",
};
