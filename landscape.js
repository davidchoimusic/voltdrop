...
const LS_TEXT = {
  ...
  compareHeading: 'The same fixtures, wired four ways',
  ...
  splitDistanceLabel: 'Split is this far from the transformer',
  splitDistanceHint: 'How far the trunk runs before it divides into two branches. Each fixture distance is then measured along its own branch, from that split.',
  hubDistanceLabel: 'Hub is this far along the path',
  hubDistanceHint: 'How far the trunk runs before it splits. A hub at 0 ft is the same circuit as a star.',
  hintTsplit: 'One trunk out to a split, then two branches running opposite ways. Distances are measured along each branch FROM THE SPLIT, not from the transformer.',
  ...
  badInput: 'Those numbers do not describe a run we can solve. Check the distances and loads.',
