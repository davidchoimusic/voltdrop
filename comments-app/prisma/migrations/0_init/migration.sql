...
-- CreateIndex
CREATE INDEX "feedback_parent_id_idx" ON "feedback"("parent_id");
...
-- AddForeignKey
ALTER TABLE "feedback" ADD CONSTRAINT "feedback_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "feedback"("id") ON DELETE CASCADE ON UPDATE CASCADE;
