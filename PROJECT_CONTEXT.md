...
(build.mjs), FAQ JSON-LD in their partial, sitemap entry, llms.txt line. Next SEO lever
(not started): article content; also David should add the site to Google Search Console.
